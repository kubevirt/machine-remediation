...
func (in *MachineHealthCheckStatus) DeepCopyInto(out *MachineHealthCheckStatus) {
	*out = *in
	if in.TargetedMachines != nil {
		in, out := &in.TargetedMachines, &out.TargetedMachines
		*out = make([]TargetedMachine, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.TargetedConditions != nil {
		in, out := &in.TargetedConditions, &out.TargetedConditions
		*out = make([]TargetedCondition, len(*in))
		copy(*out, *in)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TargetedCondition) DeepCopyInto(out *TargetedCondition) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TargetedCondition.
func (in *TargetedCondition) DeepCopy() *TargetedCondition {
	if in == nil {
		return nil
	}
	out := new(TargetedCondition)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TargetedMachine) DeepCopyInto(out *TargetedMachine) {
	*out = *in
	if in.UnhealthyConditions != nil {
		in, out := &in.UnhealthyConditions, &out.UnhealthyConditions
		*out = make([]corev1.NodeConditionType, len(*in))
		copy(*out, *in)
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TargetedMachine.
func (in *TargetedMachine) DeepCopy() *TargetedMachine {
	if in == nil {
		return nil
	}
	out := new(TargetedMachine)
	in.DeepCopyInto(out)
	return out
}
