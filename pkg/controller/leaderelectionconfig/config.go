...
func DefaultLeaderElectionConfiguration() Configuration {
	return Configuration{
		LeaseDuration: v1.Duration{Duration: DefaultLeaseDuration},
		RenewDeadline: v1.Duration{Duration: DefaultRenewDeadline},
		RetryPeriod:   v1.Duration{Duration: DefaultRetryPeriod},
