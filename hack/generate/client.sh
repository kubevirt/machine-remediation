...
client-gen --clientset-name ${CLIENTSET_NAME_VERSIONED:-versioned} --input-base "" --input ${APIS_VERSIONS} --output-package ${OUTPUT_CLIENT_PKG}/clientset --go-header-file ${REPO_DIR}/hack/boilerplate.go.txt
