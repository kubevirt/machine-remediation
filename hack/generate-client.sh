...
OUTPUT_PKG="github.com/openshift/machine-remediation-request-operator/pkg/client"
APIS_PKG="github.com/openshift/machine-remediation-request-operator/pkg/apis"
APIS_VERSIONS="${APIS_PKG}/machineremediationrequest/v1alpha1"
