...
OUTPUT_PKG="github.com/metal3-io/machine-remediation-request-operator/pkg/client"
APIS_PKG="github.com/metal3-io/machine-remediation-request-operator/pkg/apis"
