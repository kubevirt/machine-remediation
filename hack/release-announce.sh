...
downloads() {
    ...
    local GHRELURL="https://github.com/kubevirt/nore-recovery/releases/tag/"
    local RELURL="$GHRELURL$FUTURERELREF"
    cat <<EOF
The source code and selected binaries are available for download at:
<$RELURL>.

The primary release artifact of node-recovery is the git tree. The release tag is
...
[contributing]: https://github.com/kubevirt/node-recovery/blob/master/CONTRIBUTING.md
[license]: https://github.com/kubevirt/node-recovery/blob/master/LICENSE
---
